...
ActiveRecord::Schema.define(version: 20170525090222) do
  ...
  add_index "layovers", ["schedule_id"], name: "index_layovers_on_schedule_id", using: :btree
  add_index "layovers", ["station_id"], name: "index_layovers_on_station_id", using: :btree
